 ...
 * On Windows it uses {@code python.exe}; elsewhere it falls back to {@code python}.
...
public class TtsService {
    ...
    public void speak(String text) {
        ...
        String python = System.getProperty("os.name").toLowerCase().contains("win") ? "python.exe" : "python";
