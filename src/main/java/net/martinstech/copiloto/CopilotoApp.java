...
import net.martinstech.copiloto.async.ReviewScope;
import net.martinstech.copiloto.config.AppConfig;
import net.martinstech.copiloto.config.ConfigScope;
import net.martinstech.copiloto.service.GitHubService;
import net.martinstech.copiloto.service.OllamaService;
import net.martinstech.copiloto.service.SkillsService;
import net.martinstech.copiloto.service.TtsService;
import net.martinstech.copiloto.service.WebSearchService;
import net.martinstech.copiloto.ui.ChatStage;
import net.martinstech.copiloto.ui.CodeViewerStage;
import net.martinstech.copiloto.ui.HotkeyManager;
import net.martinstech.copiloto.ui.SettingsDialog;
import net.martinstech.copiloto.ui.SystemTrayManager;
import net.martinstech.copiloto.ui.WebBridge;
 ...
 */
public class CopilotoApp extends Application {
